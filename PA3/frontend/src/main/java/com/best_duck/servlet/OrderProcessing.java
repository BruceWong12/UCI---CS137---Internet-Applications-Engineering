...
public class OrderProcessing extends HttpServlet implements HttpConfig {
...
//			); // user id: need input
			...
			bodyParam.put("order_id",order_id);
			bodyParam.put("sku",Integer.parseInt(sku));
			bodyParam.put("firstname",firstname);
			bodyParam.put("lastname",lastname);
			bodyParam.put("address",address);
			bodyParam.put("city",city);
			bodyParam.put("state",state);
			bodyParam.put("zip",zip);
			bodyParam.put("shippingmethod",shippingmethod);
			bodyParam.put("qty",qty);
			bodyParam.put("cardnumber",cardnumber);
			bodyParam.put("expMonthInt",expMonthInt);
			bodyParam.put("expyearInt",expyearInt);
			bodyParam.put("cvvInt",cvvInt);
			bodyParam.put("phone",phone);
			bodyParam.put("email",email);
			bodyParam.put("user_id",user_id);
			bodyParam.put("todaysDate",todaysDate);
			http.sync("/setOrder").addBodyPara(bodyParam).post();
  		}
  		p("subtotal: " + subtotal + "\n");
