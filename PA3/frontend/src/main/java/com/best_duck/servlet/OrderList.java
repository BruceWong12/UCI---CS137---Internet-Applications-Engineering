...
public class OrderList extends HttpServlet implements HttpConfig {
    PrintWriter output;
...
//        ArrayList<Map<String, Object>> orderList = Database.getAllOrdersByUserid(userid);
        JSONArray orderList =
                JSON.parseArray(
                        http.sync("/orderlist")
