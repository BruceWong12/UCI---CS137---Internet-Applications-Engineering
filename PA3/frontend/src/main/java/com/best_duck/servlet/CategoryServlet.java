...
public class CategoryServlet extends HttpServlet implements HttpConfig {
  PrintWriter output;
  ...
  private void renderPage(HttpServletRequest req, HttpServletResponse res) throws IOException {
    ...
    String httpData =
        http.sync("/getAllProductsByCategory/" + category)
    ...
    JSONArray productArray = JSONObject.parseArray(httpData);
    int i = 0;
