...
@WebServlet(name = "MemoryCatServlet", urlPatterns = "/memory")
public class MemoryCatServlet extends HttpServlet {
    PrintWriter output;
    ...
    private void renderPage(HttpServletRequest req, HttpServletResponse res) throws IOException {
        ...
        p("<div class=\"main-container\">\n" +
                ...
                "            <table>\n" +
                "                <caption><h1>Memory(RAM)</h1></caption>\n" +
                "                <thead>\n" +
                "                <tr>\n" +
                "                    <!--<th>Table Header</th>-->\n" +
                "                </tr>\n" +
        ...
        //cards
            ...
            ArrayList<Map<String, Object>> productList = best_duck.Database.getAllProductsByCategory("Memory(RAM)");
            int i=0;
