...
@WebServlet(name = "VideoCardCatServlet", urlPatterns = "/video_card")
public class VideoCardCatServlet extends HttpServlet {
    PrintWriter output;
    ...
    private void renderPage(HttpServletRequest req, HttpServletResponse res) throws IOException {
        ...
        p("<div class=\"main-container\">\n" +
                ...
                "            <table>\n" +
                "                <caption><h1>Video Graphic Cards</h1></caption>\n" +
                "                <thead>\n" +
                "                <tr>\n" +
                "                    <!--<th>Table Header</th>-->\n" +
                "                </tr>\n" +
        ...
        //cards
            ...
            ArrayList<Map<String, Object>> productList = best_duck.Database.getAllProductsByCategory("Video Graphic Cards");
            int i=0;
