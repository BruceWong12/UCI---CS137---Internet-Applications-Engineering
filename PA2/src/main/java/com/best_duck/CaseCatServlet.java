...
@WebServlet(name = "CaseCatServlet", urlPatterns = "/case")
public class CaseCatServlet extends HttpServlet {
    PrintWriter output;
    ...
    private void renderPage(HttpServletRequest req, HttpServletResponse res) throws IOException {
        ...
        p("<div class=\"main-container\">\n" +
                ...
                "            <table>\n" +
                "                <caption><h1>Computer Cases</h1></caption>\n" +
                "                <thead>\n" +
                "                <tr>\n" +
                "                    <!--<th>Table Header</th>-->\n" +
                "                </tr>\n" +
        ...
        //cards
            ...
            ArrayList<Map<String, Object>> productList = best_duck.Database.getAllProductsByCategory("Cases");
            int i=0;
