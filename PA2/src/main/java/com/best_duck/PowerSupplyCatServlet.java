...
@WebServlet(name = "PowerSupplyCatServlet", urlPatterns = "/power_supply")
public class PowerSupplyCatServlet extends HttpServlet {
    PrintWriter output;
    ...
    private void renderPage(HttpServletRequest req, HttpServletResponse res) throws IOException {
        ...
        p("<div class=\"main-container\">\n" +
                ...
                "            <table>\n" +
                "                <caption><h1>Power Supplies</h1></caption>\n" +
                "                <thead>\n" +
                "                <tr>\n" +
                "                    <!--<th>Table Header</th>-->\n" +
                "                </tr>\n" +
        ...
        //cards
            ...
            ArrayList<Map<String, Object>> productList = best_duck.Database.getAllProductsByCategory("Power Supplies");
            int i=0;
